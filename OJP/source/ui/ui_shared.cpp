...
uiRank_t uiRank[NUM_TOTAL_SKILLS] = 
{
	...
	{3,UI_FORCE_RANK_DEMP,NUM_FORCE_POWERS+SK_DEMP,0,qfalse,0},
	{3,UI_FORCE_RANK_CONC,NUM_FORCE_POWERS+SK_CONC,0,qfalse,0},
	//[/Grenade]
	//Feats
	...
	{3,UI_FORCE_RANK_FEAT_ENERGY,NUM_FORCE_POWERS+NUM_SKILLS+FT_ENERGY,0,qfalse,0},
	//Add new skills here
};
